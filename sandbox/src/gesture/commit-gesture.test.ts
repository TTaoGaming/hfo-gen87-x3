...
} catch { ThumbMiddlePinchDetector = class { constructor() { throw new Error('ThumbMiddlePinchDetector not implemented'); } }; }

try {
  PointerStabilityTracker = require('./pointer-stability.js').PointerStabilityTracker;
} catch { PointerStabilityTracker = class { constructor() { throw new Error('PointerStabilityTracker not implemented'); } }; }

try {
  StickyArmedFSM = require('./sticky-armed-fsm.js').StickyArmedFSM;
} catch { StickyArmedFSM = class { constructor() { throw new Error('StickyArmedFSM not implemented'); } }; }

try {
  CommitHysteresis = require('./commit-hysteresis.js').CommitHysteresis;
} catch { CommitHysteresis = class { constructor() { throw new Error('CommitHysteresis not implemented'); } }; }

try {
  ResetConditionDetector = require('./reset-condition.js').ResetConditionDetector;
} catch { ResetConditionDetector = class { constructor() { throw new Error('ResetConditionDetector not implemented'); } }; }

try {
  CommitGestureAdapter = require('./commit-gesture-adapter.js').CommitGestureAdapter;
} catch { CommitGestureAdapter = class { constructor() { throw new Error('CommitGestureAdapter not implemented'); } }; }
...
describe('ThumbMiddlePinchDetector (pointer_up gesture)', () => {
  ...
  it('should return confidence between 0 and 1 (property)', () => {
    fc.assert(fc.property(handLandmarksArb, (landmarks) => {
      const detector = new ThumbMiddlePinchDetector();
