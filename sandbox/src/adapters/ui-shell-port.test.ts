...
describe("UIShellPort", () => {
  describe("Interface Compliance", () => {
    it("should define UIShellPort interface with all required methods", () => {
      ...
      expect(() => createUIShellFactory()).toThrow(
        "UIShellFactory not implemented"
      );
    });

    it("should create shell via factory pattern", () => {
      const createShell = (
        type: "mosaic" | "golden-layout" | "puter"
      ): UIShellPort => {
  ...
  describe("MosaicShell (react-mosaic)", () => {
    describe("Window Management", () => {
      it("should create window with mosaic tile", () => {
        ...
        expect(() => createMosaicShell()).toThrow(
          "MosaicShell not implemented"
        );
      });
      ...
      it("should support binary split layout", () => {
        ...
        expect(() =>
          splitWindow({ id: "1" } as WindowHandle, "horizontal")
        ).toThrow("MosaicShell split not implemented");
      });

      it("should handle mosaic drag to rearrange", () => {
        // RED: MosaicShell drag not implemented
        const handleMosaicDrag = (
          _nodeId: string,
          _newParentId: string
        ): void => {
    ...
    describe("Gesture Integration", () => {
      it("should route pointer events to correct mosaic tile", () => {
        ...
        expect(() =>
          routeToMosaicTile({ clientX: 100, clientY: 100 })
        ).toThrow("MosaicShell routing not implemented");
      });

      it("should support per-tile gesture targets", () => {
        // RED: MosaicShell per-tile targets not implemented
        const registerTileTarget = (
          _tileId: string,
          _target: GestureTargetPort
        ): void => {
          throw new Error("Per-tile targets not implemented");
        };

        expect(() =>
          registerTileTarget("tile1", { handlePointerEvent: vi.fn() })
        ).toThrow("Per-tile targets not implemented");
      });
    });
  });
  ...
  describe("GoldenLayoutShell", () => {
    describe("Window Management", () => {
      it("should create window with golden-layout component", () => {
        ...
        expect(() => createGoldenLayoutShell()).toThrow(
          "GoldenLayoutShell not implemented"
        );
      });
      ...
      it("should support floating windows (popouts)", () => {
        ...
        expect(() => createPopout("editor")).toThrow(
          "GoldenLayout popouts not implemented"
        );
      });
    });
    ...
    describe("Gesture Integration", () => {
      it("should route pointer events based on golden-layout hierarchy", () => {
        ...
        expect(() =>
          routeToGoldenLayoutItem({ clientX: 100, clientY: 100 })
        ).toThrow("GoldenLayout routing not implemented");
      });
      ...
      it("should handle tab header vs content area differently", () => {
        ...
        expect(() =>
          isTabHeader({ clientX: 100, clientY: 10 }, "editor")
        ).toThrow("Tab header detection not implemented");
      });
    });
  });
  ...
  describe("PuterShell (daedalOS-style)", () => {
    ...
    describe("Desktop Icons", () => {
      it("should support desktop icon layout", () => {
        ...
        expect(() => getDesktopIcons()).toThrow(
          "PuterShell desktop icons not implemented"
        );
      });
      ...
      it("should handle double-click to launch app", () => {
        ...
        expect(() => launchFromIcon("notepad")).toThrow(
          "PuterShell icon launch not implemented"
        );
      });
    });
    ...
    describe("Gesture Integration", () => {
      it("should route pointer events to topmost window at coordinates", () => {
        ...
        expect(() =>
          routeToPuterWindow({ clientX: 100, clientY: 100 })
        ).toThrow("PuterShell routing not implemented");
      });
      ...
      it("should detect resize handles", () => {
        ...
        expect(() =>
          getResizeHandle(
            ...
            { id: "1", bounds: { x: 0, y: 0, width: 400, height: 300 } } as WindowHandle
          )
      ...
      it("should support gesture-based window drag", () => {
        ...
        expect(() =>
          startGestureDrag({ id: "1" } as WindowHandle, { x: 100, y: 20 })
        ).toThrow("Gesture window drag not implemented");
      });
    });
    ...
    describe("Taskbar Integration", () => {
      it("should show taskbar with running applications", () => {
        ...
        expect(() => getTaskbarItems()).toThrow(
          "PuterShell taskbar not implemented"
        );
      });
      ...
      it("should handle gesture click on taskbar item", () => {
        ...
        expect(() => clickTaskbarItem("window1")).toThrow(
          "Taskbar click not implemented"
        );
      });
    });
  });
  ...
  describe("Cross-Shell Polymorphism", () => {
    it("should route same gesture event to any shell type", () => {
      ...
      expect(() =>
        routeEvent({} as UIShellPort, { clientX: 100, clientY: 100 })
      ).toThrow("Cross-shell routing not implemented");
    });
