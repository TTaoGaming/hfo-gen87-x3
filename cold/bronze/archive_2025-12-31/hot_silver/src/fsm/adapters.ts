...
export class SyntheticFrameAdapter implements IPointerFramePort {
	...
	constructor(id = 'synthetic-1', frameRateMs = 16) {
		this.id = id;
...
export class LoggerAdapter implements IPointerActionPort {
	...
	constructor(id = 'logger-1', maxEntries = 10000) {
		this.id = id;
...
export class WebSocketAdapter implements IPointerActionPort {
	...
	constructor(id = 'ws-1', url = 'ws://localhost:8080', reconnectMs = 3000) {
		this.id = id;
		this.url = url;
