 ...
 * FSM State enum
 */
export const FSMState = z.enum(['IDLE', 'TRACKING', 'ARMED', 'ENGAGED', 'COASTING']);
export type FSMState = z.infer<typeof FSMState>;

/**
 * W3C Pointer Event Types we emit
 */
export const PointerEventType = z.enum(['none', 'enter', 'move', 'down', 'up', 'cancel', 'leave']);
 ...
 */
export function createLostFrame(
	ts: number,
