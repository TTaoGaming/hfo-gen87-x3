...
// ============================================================================
// COMPOSER PORT (Tile Pipeline Composition)
// Manages per-tile pipelines with runtime adapter swapping
// Implemented by: TileComposer
// ============================================================================
...
export interface ComposerPort {
	 ...
	 * Config type is flexible to allow implementation-specific extensions
	 */
	addTile(config: import('./schemas.js').TileConfig & Record<string, unknown>): void;
	...
	/**
	 * Process a video frame through all active tile pipelines
	 * Returns implementation-specific frame results
	 */
	processFrame(video: HTMLVideoElement, timestamp: number): Promise<unknown>;

	/**
	 * Get composer state for serialization
	 */
	getState(): unknown;
...
// ============================================================================
// SUBSTRATE PORT (NATS JetStream Message Bus)
// Production-ready stigmergy substrate for distributed coordination
// Implemented by: NatsSubstrateAdapter
// ============================================================================
