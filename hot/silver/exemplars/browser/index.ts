/**
 * HFO Browser Entry Point (Silver Exemplar)
 *
...
export {
	...
	type SmoothedFrame,
	type VideoFrame,
} from '../../../bronze/src/contracts/schemas.js';

export type { FSMPort, SensorPort, SmootherPort } from '../../../bronze/src/contracts/ports.js';

// ============================================================================
// SENSOR ADAPTERS (Port 0 - SENSE)
// ============================================================================
export { MediaPipeAdapter } from '../../../bronze/src/adapters/mediapipe.adapter.js';
...
export {
	...
	type OneEuroConfig,
} from '../../../bronze/src/adapters/one-euro-exemplar.adapter.js';
...
export {
	...
	type RapierConfig,
} from '../../../bronze/src/adapters/rapier-physics.adapter.js';

// DESP - Double Exponential Smoothing Predictor (LaViola 2003)
export {
	DoubleExponentialPredictor,
	type DESPConfig,
} from '../../../bronze/src/adapters/double-exponential-predictor.adapter.js';

// ============================================================================
// FSM ADAPTER (Port 3 - DELIVER) - XState v5 State Machine
// ============================================================================
export { XStateFSMAdapter } from '../../../bronze/src/adapters/xstate-fsm.adapter.js';
...
export {
	DOMAdapter,
	PointerEventAdapter,
} from '../../../bronze/src/adapters/pointer-event.adapter.js';

// ============================================================================
// UI SHELL ADAPTER (Port 7 - NAVIGATE) - GoldenLayout 2.6.0
// ============================================================================
export { GoldenLayoutShellAdapter } from '../../../bronze/src/adapters/golden-layout-shell.adapter.js';
...
} from '../../../bronze/src/adapters/port-factory.js';
...
} from '../../../bronze/src/gates/palm-cone-gate.js';
...
} from '../../../bronze/src/gates/gesture-transition-predictor.js';
...
} from '../../../bronze/src/pipeline/hfo-pipeline.js';
...
export { InMemorySubstrateAdapter } from '../../../bronze/src/adapters/in-memory-substrate.adapter.js';
...
} from '../../../bronze/src/adapters/nats-substrate.adapter.js';
...
export {
	...
	type TraceContext,
} from '../../../bronze/src/shared/trace-context.js';
...
} from '../../../bronze/src/constants/magic-numbers.js';
...
import type { SensorFrame } from '../../../bronze/src/contracts/schemas.js';
