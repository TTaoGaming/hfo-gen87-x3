...
import { W3CPointerFSM, DEFAULT_GATE_CONFIG, type PointerFrame, type W3CPointerAction } from './w3c-pointer-fsm.js';
...
function runSequence(fsm: W3CPointerFSM, frames: PointerFrame[]): { states: string[]; actions: W3CPointerAction[] } {
...
describe('ADVERSARIAL: Noise Injection & Rapid Oscillation', () => {
  ...
  it('POSITION JITTER: Rapid position changes', () => {
    const frames: PointerFrame[] = [
      ...
      generateFrame(1332, 20, 'Pointing_Up', { position: { x: 0.50, y: 0.51 } }),
