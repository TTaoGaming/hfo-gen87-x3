...
import { z } from "zod";
import type { PortNumber, HIVEPhase, HFOVerb } from "./hfo-ports.js";
...
export const PORT_0_CONTRACT: PortBehavioralContract = {
  ...
  behaviors: [
    ...
    },
    {
      ...
      and: [
        "Events contain diff metadata only",
        "Original data reference is preserved",
      ],
    },
    {
      ...
      and: [
        "Resolution is deferred to Port 7 (DECIDE)",
        "All possible interpretations are tagged",
      ],
    },
  ],
...
export const GALOIS_LATTICE = {
  ...
  getQuestion(row: PortNumber, col: PortNumber): string {
    const verbs: Record<PortNumber, string> = {
      0: "SENSE", 1: "FUSE", 2: "SHAPE", 3: "DELIVER",
      4: "TEST", 5: "DEFEND", 6: "STORE", 7: "DECIDE",
    };
