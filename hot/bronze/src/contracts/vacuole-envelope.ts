...
export interface VacuoleOptions {
	...
	hfostage?: number | undefined;
	/** Parent traceparent for propagation (optional) */
	parentTrace?: Traceparent | undefined;
	/** NATS subject (optional) */
	hfonats?: string | undefined;
	/** Mark/confidence (optional) */
	hfomark?: number | undefined;
	/** Pull direction (optional) */
	hfopull?: 'upstream' | 'downstream' | 'lateral' | undefined;
}
